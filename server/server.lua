...
lib.callback.register("nf-vehiclemileage:server:get-mileage", function(_, plate)
  return getMileageInKmByPlate(plate)
end)

RegisterNetEvent("nf-vehiclemileage:server:update-mileage", function(plate, mileage)
